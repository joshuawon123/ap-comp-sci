...
class starter {
	public static void main(String args[]) {
		...
		System.out.println(Cipher.encode("xs uvvy5 1r 9w 5ruvsqr 7v972"));
	/*int won = 0;
		while(won < 37)
		{
			System.out.println(Cipher.keyedEncode("amlb mfhp7fcj jlgq fo tap s9a bjlslql aflipa lb hlg9b 210z t9ct", won));
	...
	int poole = 0;
		while(poole < 37)
		{
			System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y", poole));
